...
main:	stp x29, x30, [sp, -16]!     // Save FP and LR to stack
    ...
    mov multiplicand, -252645136      // Changes the value of multiplicand to -252645136
    mov multiplier, -256              // Changes the value of multiplier to -256
